...
import { getAllBooks, createBook, getBookById, deleteBook, updateBook, searchBookByTitle} from '../controllers/bookController.js'
...
booksRouter.route('/searchByTitle').post(searchBookByTitle)
